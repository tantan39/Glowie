...
import RxCocoa
import RxSwift
class AudioContestCollectionViewCell: BaseCollectionViewCell {
    ...
    private let contestTypeLabel: UILabel = {
        ...
        label.text = "Hiding Face Contest"
    ...
    private let bannerImageView: UIImageView = {
        ...
        imgView.image = UIImage(named: "background-audio-contets")
        return imgView
    }()
...
extension AudioContestCollectionViewCell {
