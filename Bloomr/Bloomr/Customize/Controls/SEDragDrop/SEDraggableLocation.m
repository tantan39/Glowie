...
//@property (nonatomic, readwrite, strong) ThankYou *thankyouView;
...
//thankyou view
//- (NSInteger) thankyouStyle {
//    return self.thankyouView.popupStyle;
//}
//- (void) setThankyouStyle:(NSInteger) thankyouStyle{
////    if(self.thankyouView == nil){
//        self.thankyouView =  [[ThankYou alloc]initWithStyle:thankyouStyle atPoint:self.frame.origin frame:self.frame];
//        [self showThankyou:YES ];
//        [self addSubview:self.thankyouView];
////    } else {
////        self.thankyouView.popupStyle = thankyouStyle;
////    }
//}
//- (void) showThankyou:(BOOL)show {
//    self.thankyouView.layer.hidden = !show;
//}
//-(void) repositionThankyou:(CGPoint)newPos{
//    [self.thankyouView repositionToPoint:newPos];
//}
...
#warning //[encoder encodeType(?):self.animationOptions forKey:kANIMATION_OPTIONS_KEY];
    ...
    [encoder encodeInteger:self.thankyouStyle forKey:kTHANKYOU_STYLE_KEY];
}
...
#warning //[self setAnimationOptions:[decoder decodeType(?)ForKey:kANIMATION_OPTIONS_KEY]];
        ...
        //VL
        if ([decoder containsValueForKey:kTHANKYOU_STYLE_KEY])
            self.thankyouStyle = [decoder decodeIntegerForKey:kTHANKYOU_STYLE_KEY];
    }
    return self;
}
...
- (id)copyWithZone:(NSZone *)zone {
    ...
    //VL
    [theCopy setThankyouStyle:self.thankyouStyle];
